    ...
    if v.check_credentials():
        ...
        if mode == 'Visuals 📈':
            ...
            if graphs == 'Scatter Plot':
                ...
                fig = plt.figure()
                ax = fig.add_subplot()
                ax.axline(x = v.overall_1, y = df1["absence"], s=10, c='b', marker="s", label='first_semester')
                ax.axline(x = v.overall_2, y = df2["absence"], s=10, c='r', marker="o", label='second_semester')
