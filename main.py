    ...
    if v.check_credentials():
        ...
        if mode == "Reviews":
            ...
            if reviews == 'Sociology Reviews':
                st.download_button('Download Top words in Sociology Review: (.txt file)', data = v.my_str, file_name = 'soc_review.txt' )
                v.print_statement(v.soc_reviews, v.sorted_review_soc)
            if reviews == 'Psychology Reviews':
                st.download_button('Download Top words in Psychology Review: (.txt file)', data = v.my_str, file_name = 'psy_review.txt' )
